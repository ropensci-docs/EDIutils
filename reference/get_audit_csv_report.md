...
(data.frame or xml_document) Zero or more audit records matching the
query parameters as specified in the request (see details below) and
...
indicate a time span. When toTime is absent, the report will consist of
